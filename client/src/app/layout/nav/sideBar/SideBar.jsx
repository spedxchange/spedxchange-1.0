  ...
  render() {
    ...
    return (
      <Menu text vertical className='app-sidebar'>
        ...
        <Menu.Item link name='Resources' path='/' active={activeItem === 'Resources'} onClick={this.handleItemClick} />
        ...
        <hr />
        <Menu.Item link name='Questions' path='/news' active={activeItem === 'Questions'} onClick={this.handleItemClick} />
        <Menu.Item link name='Categories' path='/news' active={activeItem === 'Categories'} onClick={this.handleItemClick} className='indent' />
