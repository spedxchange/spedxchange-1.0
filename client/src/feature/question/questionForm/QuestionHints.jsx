...
const QuestionHints = () => {
  return (
    <div className='question-hints'>
      <h5>Step 1: Draft Your Question</h5>
      <p>The community is here to help you with SPED-related issues.</p>
      <p>
        Ask questions that can be <em>answered,</em> not just discussed.
      </p>
      <p>
        Opinions should be backed up either <strong>with a reference</strong>, or experiences that <strong>happened to you personally</strong>.
      </p>
      <section>
        <h6>1. Summarize Your Question</h6>
        <ul>
      ...
      <section>
        <h6>2. Describe What You've Tried</h6>
        <ul>
